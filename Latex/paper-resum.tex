...
\end{equation*}
The error $E(t_0)$ is given by (\ref{f_x_y}) with $f(x,y)=\frac{\frac{P_{ois}(t_0,t_1,x,y)}{P_{ois}(t_0,t_2,x,y)} -1}{\delta_{t_0,t_1}}$ and behaves as $\mathcal{O}(t_0)$ when $t_0 \to 0$ and $\|E(t_0)\|^{2}_{2} < \infty$ when $t_0 \to \infty$. 
\end{theorem}
\begin{proof}
