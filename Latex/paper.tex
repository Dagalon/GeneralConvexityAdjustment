...
\Gamma(s,t_0,t_1) &= \frac{\exp(-ks)\sigma}{k}\left(\exp(-k(\max(s,t_0) - s)) - \exp(-k(t_1-t_0))\right)\\
...
Therefore we have that
\begin{align*}
\frac{\int_{0}^{t_1} \Gamma^{2}(s,t_0,t_1) ds}{2} &= \frac{\sigma^{2}}{2k^{2}} \int_{0}^{t_1}  \exp(-2ks)\left(\exp(-k(\max(s,t_0) - s)) - \exp(-k\delta_{t_0,t_1})\right)^{2} ds \\
&= \frac{\sigma^{2}}{2k^{2}} \int_{0}^{t_0} \exp(-2ks)\left(\exp(-k(t_0 - s)) - \exp(-k\delta_{t_0,t_1})\right)^{2} ds\\
&+ \frac{\sigma^{2}}{2k^{2}} \int_{t_0}^{t_1} \exp(-2ks)\left(1 - \exp(-k\delta_{t_0,t_1})\right)^{2} ds\\
&= \frac{\sigma^{2}}{2k^{2}} \left(\delta_{t_0,t_1}+ \exp(-2k\delta_{t_0,t_1}) \frac{\exp(-2kt_0)- \exp(-2kt_1)}{2k} - 2\exp(-kt_1) \frac{\exp(-kt_0)- \exp(-kt_1)}{k}  \right) \\
