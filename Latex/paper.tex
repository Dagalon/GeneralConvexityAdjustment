...
&CA_{CMS}(T_a,T_b)  \\
&\approx  01(0,T_a,T_b)  f^{\prime}(S^{ois}_{a,b}(0)) \nonumber \\
&\cdot \partial_{x}S_{a,b}(0,\bar{x}_0, \bar{y}({T_a}) \partial_{x}S^{ois}_{a,b}(0,\bar{x}_0, \bar{y}({T_a}))\int_0^{T_a} \eta^{2}(u,\bar{x}_0, \bar{y}({T_a})) du \nonumber
\end{align}
}}
