...
\begin{equation}\label{ca_future}
...
Now, from (\ref{ca_future}) and (\ref{approximation_clarkocone}) we have the next approximation for the convexity adjustmet for future
...
{
\begin{equation}
CA(t,t_0,t_1) \approx \frac{P_{E}(0,t_1)}{\delta_{t_1,t_2} P_{E}(0,t_2)} \left(G(t_0,t_2) - G(t_0,t_1)\right) \int_{0}^{t_0}  \beta(s,t_0, x_0, \hat{y}_s) ds. 
\end{equation}
}}
\begin{example}
Hull-White model
