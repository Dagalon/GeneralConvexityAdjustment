...
\eqref{forward_rate} and \eqref{future}, then the convexity adjustment definition is:%From \eqref{forward_rate} and \eqref{future}, we will define the convexity adjustment as
\begin{equation*}
